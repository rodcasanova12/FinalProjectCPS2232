...
//CLASS TO COMPARE THE STUDENTS VIEW
public class StudentViewComparator implements Comparator<Movie> {
   ...
   public int compare(Movie s1, Movie s2) {
	 //IT WILL COMPARE IF S1 RATING IS BIGGER THAN S2 
       if (s1.getNoOfStudentsSaw() < s2.getNoOfStudentsSaw())
    	   //WILL RETURN 1 IF S2 RATING IS BIGGER THAN S1
    	   return 1;
     //IT WILL COMPARE IF S1 RATING IS BIGGER THAN S2
       else if (s1.getNoOfStudentsSaw() > s2.getNoOfStudentsSaw())
